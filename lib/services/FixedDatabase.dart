...
//readTransaction in sql_api was declared abstract class Database
//BriteDatabase didn't implement it yet causing compile error
//Extend BriteDatabase to temporary implement the readTransaction
class FixedDatabase extends AbstractBriteDatabaseExecutor
  ...
  FixedDatabase(this._db, {this.logger = print}) : super(_db) {
